...
/**
 * <p>Java class for DigitalInputConfigurationInputOptions complex type</p>.
 * 
...
public class DigitalInputConfigurationInputOptions {
     ...
     * This is why there is not a <CODE>set</CODE> method for the idleState property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the idleState property.
     */
    public List<DigitalIdleState> getIdleState() {
        if (idleState == null) {
            idleState = new ArrayList<>();
        }
