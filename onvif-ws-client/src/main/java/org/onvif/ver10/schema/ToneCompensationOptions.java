...
/**
 * <p>Java class for ToneCompensationOptions complex type</p>.
 * 
...
public class ToneCompensationOptions {
    ...
    /**
     * Supported options for Tone Compensation mode. Its options shall be
     *             chosen from tt:ToneCompensationMode Type.
     * 
     */
    @XmlElement(name = "Mode", required = true)
    protected List<String> mode;
    /**
     * Indicates whether or not support Level parameter for Tone
     *             Compensation.
     * 
     */
