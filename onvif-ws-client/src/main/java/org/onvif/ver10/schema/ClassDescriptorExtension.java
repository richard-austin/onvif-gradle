...
/**
 * <p>Java class for ClassDescriptorExtension complex type</p>.
 * 
...
public class ClassDescriptorExtension {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the otherTypes property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the otherTypes property.
     */
