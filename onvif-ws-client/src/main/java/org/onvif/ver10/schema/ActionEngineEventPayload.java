...
/**
 * Action Engine Event Payload data structure contains the information about
 *         the ONVIF command invocations. Since this event could be generated by other or proprietary
 *         actions, the command invocation specific fields are defined as optional and additional
 *         extension mechanism is provided for future or additional action definitions.
 * 
 * <p>Java class for ActionEngineEventPayload complex type</p>.
 * 
