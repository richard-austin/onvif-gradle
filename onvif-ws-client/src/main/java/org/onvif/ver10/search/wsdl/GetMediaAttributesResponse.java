...
public class GetMediaAttributesResponse {
     ...
     * This is why there is not a <CODE>set</CODE> method for the mediaAttributes property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the mediaAttributes property.
     */
    public List<MediaAttributes> getMediaAttributes() {
        if (mediaAttributes == null) {
            mediaAttributes = new ArrayList<>();
        }
