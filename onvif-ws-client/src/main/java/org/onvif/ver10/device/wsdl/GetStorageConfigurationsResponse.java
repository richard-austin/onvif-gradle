...
public class GetStorageConfigurationsResponse {
     ...
     * This is why there is not a <CODE>set</CODE> method for the storageConfigurations property.</p>
     * 
     * <p>
