...
;
    ...
    public void getAccessProfileList(
        ...
        jakarta.xml.ws.Holder<java.lang.String> nextStartReference,
        @WebParam(mode = WebParam.Mode.OUT, name = "AccessProfile", targetNamespace = "http://www.onvif.org/ver10/accessrules/wsdl")
        jakarta.xml.ws.Holder<java.util.List<org.onvif.ver10.accessrules.wsdl.AccessProfile>> accessProfile
    );
    ...
    public void getAccessProfileInfoList(
        ...
        jakarta.xml.ws.Holder<java.util.List<org.onvif.ver10.accessrules.wsdl.AccessProfileInfo>> accessProfileInfo
    );
}
